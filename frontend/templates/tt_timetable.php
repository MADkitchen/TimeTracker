        ...
        <div class="w3-modal-content w3-red w3-animate-opacity w3-card-4">
            <div class="w3-container w3-padding-large">
                <div class="w3-container w3-cell w3-half">
                    <input type="number" placeholder="Hours" id="ts_modal_entry" class="w3-input w3-red w3-border w3-center w3-xxlarge w3-padding-32" min="0" max="24" step="0.01">
                </div>
                <div class="w3-container w3-cell w3-half">
                    <div id="ts_modal_entry_submit" onclick="update_entry()" class="w3-button w3-red w3-ripple w3-cell w3-third w3-xxlarge">&plus;</div>
                    <div id="ts_modal_entry_remove" onclick="update_entry(true)" class="w3-button w3-red w3-ripple w3-cell w3-third w3-xxlarge">&minus;</div>
                    <div id="ts_modal_entry_close" onclick="jQuery('#ts_modal_newentry').hide()" class="w3-button w3-red w3-ripple w3-cell w3-third w3-xxlarge">&times;</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="w3-responsive">
    <table class="w3-table-all w3-card w3-center">
        <?php build_timesheet() ?>
    </table>
</div>
